...
//            }
        ...
        void getLoggingInfo(const Eigen::Vector3d &command, Eigen::Ref<EigenVec> info) {
            ...
            infoBag << pogo_->getGeneralizedCoordinate().e().tail(nJoints_), // 0,1,2
                    ...
                    bodyLinVel_, bodyLinVel2_,  // 9,10,11, 12,13,14
                    bodyAngVel_, bodyAngVel2_,  // 15,16,17, 18,19,20
                    command, // 21,22,23
                    pTarget_.tail(nJoints_), // 24,25,26
                    airTime_, stanceTime_, // 27,28
                    baseHeight_; //29
        ...
        static constexpr size_t valueObDim_ = 27;
